 ...
 *
 *=========================================================================*/
#ifndef __itkLBFGSBOptimizer2_h
#define __itkLBFGSBOptimizer2_h
 ...
 * \ingroup ITKOptimizers
 */
class LBFGSBOptimizer2:
  public SingleValuedNonLinearVnlOptimizer
{
public:
  /** Standard "Self" typedef. */
  typedef LBFGSBOptimizer2                   Self;
  ...
  itkTypeMacro(LBFGSBOptimizer2, SingleValuedNonLinearVnlOptimizer);
  ...
  /** Set the x_tol*/
  virtual void SetXTol(double);

    virtual void SetFTol(double);
...
protected:
  LBFGSBOptimizer2();
  virtual ~LBFGSBOptimizer2();
  virtual void PrintSelf(std::ostream & os, Indent indent) const ITK_OVERRIDE;

  typedef Superclass::CostFunctionAdaptorType CostFunctionAdaptorType;

private:
  LBFGSBOptimizer2(const Self &); //purposely not implemented
