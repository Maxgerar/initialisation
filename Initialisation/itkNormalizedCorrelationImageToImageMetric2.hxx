 ...
 *
 *=========================================================================*/
#ifndef __itkNormalizedCorrelationImageToImageMetric2_hxx
#define __itkNormalizedCorrelationImageToImageMetric2_hxx
...
::GetValue(const TransformParametersType & parameters) const
{
  ...
  FixedIteratorType ti( fixedImage, this->GetFixedImageRegion() );
    ...
    std::cout<<"fixed region size : "<<this->GetFixedImageRegion().GetSize()<<std::endl;
    std::cout<<"fixed mask test : "<<this->m_FixedImageMask->GetLargestPossibleRegion().GetSize()<<std::endl;
    std::cout<<"moving mask test : "<<this->m_MovingImageMask->GetLargestPossibleRegion().GetSize()<<std::endl;
  ...
  while( !ti.IsAtEnd() )
    ...
    std::cout<<"Number of pixels counted : "<<this->m_NumberOfPixelsCounted<<std::endl;
                        ...
                        MeasureType & value, DerivativeType  & derivative) const
{
  ...
  derivativeM1.Fill(NumericTraits<typename DerivativeType::ValueType>::Zero);
