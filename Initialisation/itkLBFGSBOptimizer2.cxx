 ...
 *
 *=========================================================================*/
#ifndef __itkLBFGSBOptimizer2_hxx
#define __itkLBFGSBOptimizer2_hxx
...
::SetMaximumNumberOfCorrections(unsigned int value)
{
  ...
  this->Modified();
    ...
    void LBFGSBOptimizer2::SetXTol(double tol)
    {
        m_x_tol = tol;
        if ( m_OptimizerInitialized )
        {
            ...
            std::cout<<"x tolerance : "<<m_VnlOptimizer->get_x_tolerance()<<std::endl;
        }
        this->Modified();
    ...
    void LBFGSBOptimizer2::SetFTol(double tol)
    {
        m_f_tol =tol;
        ...
        this->Modified();
        //std::cout<<"f tolerance : "<<m_VnlOptimizer->get_f_tolerance()<<std::endl;
 ...
 */
void
LBFGSBOptimizer2::SetCostFunction(SingleValuedCostFunction *costFunction)
{
  ...
  m_VnlOptimizer->set_max_variable_metric_corrections(
    m_MaximumNumberOfCorrections);
//    m_VnlOptimizer->set_x_tolerance(m_x_tol);
//    m_VnlOptimizer->set_f_tolerance(m_f_tol);
    
    //std::cout<<"xtol : "<<m_VnlOptimizer->get_x_tolerance()<<std::endl;
...
//  // in the variable provided as initial position
    std::cout<<"xtol : "<<m_VnlOptimizer->get_x_tolerance()<<std::endl;
    std::cout<<"ftol : "<<m_VnlOptimizer->get_f_tolerance()<<std::endl;
...
const std::string
LBFGSBOptimizer2::GetStopConditionDescription() const
{
